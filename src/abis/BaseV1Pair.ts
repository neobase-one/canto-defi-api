export const BaseV1PairMetadata = {
  "abi": [
    {
      "inputs": [],
  ...
  "storageLayout": {
    "storage": [
      ...
      },
      {
        ...
        "offset": 0,
        "slot": "8",
        "type": "t_array(t_struct(Observation)65_storage)dyn_storage"
      },
      {
        "astId": 78,
        "contract": "contracts/BaseV1-core.sol:BaseV1Pair",
      ...
      },
      {
        "astId": 88,
        "contract": "contracts/BaseV1-core.sol:BaseV1Pair",
        "label": "totalSupplyCumulativeLast",
        "offset": 0,
        "slot": "14",
        "type": "t_uint256"
      },
    ...
    "types": {
      ...
      "t_array(t_struct(Observation)65_storage)dyn_storage": {
        "base": "t_struct(Observation)65_storage",
        "encoding": "dynamic_array",
        "label": "struct BaseV1Pair.Observation[]",
        "numberOfBytes": "32"
      },
      "t_bytes32": {
        "encoding": "inplace",
      ...
      "t_struct(Observation)65_storage": {
        "encoding": "inplace",
        "label": "struct BaseV1Pair.Observation",
        "members": [
          {
